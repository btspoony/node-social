...
wyxClient.prototype.authorize = function (req, res, callback) {
	...
	var hash = this._buildSignature(basestring, this.secret);
	if(hash !== signature){
...
wyxClient.prototype.get = function(api, param, callback) {
	if (!this.user.userId ) return callback("not authorize");
