...
SocialBase.prototype.authorize = function authorize (req, res, callback, context){
  callback.call(context, new Error('missing implementation of authorize') );
};

SocialBase.prototype.get = function get(api, param, callback, context) {
  callback.call(context, new Error('missing implementation of get') );
};

SocialBase.prototype.post = function post(api, body, callback, context) {
...
SocialBase.prototype.commonAPIGet = function commonAPIGet(apiname, param, callback, context) {
...
SocialBase.prototype.commonAPIPost = function commonAPIPost(apiname, param, callback, context) {
  var api = this.api[apiname];
...
for (var key in commonAPIs) {
  ...
  SocialBase.prototype[key] = (function(name, method){
...
SocialBase.prototype.checkSignature = function(query){
  return true;
}
