...
// common api
WeiboAPI.user_getInfo = WeiboAPI.verify_credentials;
...
var WeiyxAPI = exports.WeiyxAPI = {
	...
	// Basic Info
	apiurl: 'http://game.weibo.com/api/1/',
	result_format: '.json',
	...
	user_app_friends: 'user/app_friends',  // get all friends(installed app)' info (limit 20)
	user_app_friends: 'user/app_friend_ids', // get all friends(installed app)' id
...
// common api
WeiyxAPI.user_getInfo = WeiyxAPI.user_show;
...
// common api
RenRenAPI.user_getInfo = RenRenAPI.users_getinfo;
