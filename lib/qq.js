...
QQ.prototype.post = function(uri, param, callback) {
  var isHttps = uri == this.api.pay_request 
 ...
 */
SocialBase.prototype.filterResponse = function(direct, err, data) {
  if( data.ret != 0 ){
    err = { ret: data.ret, msg: data.msg };
  }

  SocialBase.prototype.filterResponse.call(this, direct, err, data );
};
...
QQ.prototype.payment_request = function(param, callback ) {
  ...
  SocialBase.prototype.pay_request.call( this, param, callback );
};
 ...
 *                             eg: function( callback ) {}
 * @param {Function} onDelivered called when confirm delivery finished, no callback
 *                             eg: function( err, data ) {}
 */
QQ.prototype.payment_callback = function( req, res, onSuccess, onFail, onDelivered ) {
  ...
  var responseFunc = function( ret ) {
    ...
    // setup confirm Param then send confirm_delivery
    var confirmParam = {};
    // res parameters
    ...
    // start confirmPayment process
    this.confirm_payment( confirmParam, onDelivered );
  }
  var retno;
...
/**
 * Invoked by confirm_delivery, or you can call it directly
 * @param  {Object}   param    Request parameters ( refer to http://wiki.open.qq.com/wiki/v3/pay/confirm_delivery )
 * @param  {Function} callback
 */
