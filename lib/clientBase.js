...
for (var key in commonAPIs) {
	clientBase.prototype[key] = function(param, callback, context){
		var func = arguments.callee;
		var api = this.api[func.apiname];
		if(api) (this[func.apimethod])(api, param, function(err, data){
			...
			callback.call(context, new Error("not support api:" + func.apiname) );
	};
	clientBase.prototype[key].apiname = apiname = commonAPIs[key];
	clientBase.prototype[key].apimethod = apiname.substring(0, apiname.indexOf("_"));
};
